...
Currently, the man page for re-exported functions (`man/reexports.Rd`)
is excluded from this check, as it's not possible to add runnable examples
for the re-rexported functions.
