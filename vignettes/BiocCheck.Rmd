...
If this line is not present, it means `R` has not detected that a vignette
needs to be built.
...
* **Checking for non-trivial biocViews...**
  Checks that biocViews are more specific than the top-level terms Software,
  AnnotationData, or ExperimentData (`REQUIRED`)
