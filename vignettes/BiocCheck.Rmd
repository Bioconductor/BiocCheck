...
* Check that the package maintainer is registered on the Bioconductor
  ...
  and questions. Therefore, it is important for maintainers to register
  their package name as a 'Watched Tag' on the support site in order to receive
  email notifications whenever users ask questions about the package.
  `BiocCheck` will cross-check the maintainer's 'Watched Tags' with
  the current package and produce an `ERROR` if the package name is not in the
